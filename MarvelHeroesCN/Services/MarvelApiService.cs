...
using MarvelHeroesCN.Helpers;
using MarvelHeroesCN.Models;
using Newtonsoft.Json;

namespace MarvelHeroesCN.Services
{
    public class MarvelApiService     {         private static string[] HEROIS = new string[]         {             "Captain America", "Iron Man", "Thor", "Hulk",             "Wolverine", "Spider-Man", "Black Panther",             "Doctor Strange", "Daredevil"         };          public async Task<List<Personagem>> GetPersonagensAsync()         {
